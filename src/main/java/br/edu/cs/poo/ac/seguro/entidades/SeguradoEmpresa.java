...
public class SeguradoEmpresa extends Segurado implements Serializable {
	...
	public SeguradoEmpresa(String nome, Endereco endereco, LocalDate dataAbertura, BigDecimal bonus, String cnpj,
			double faturamento, boolean ehLocadoraDeVeiculos) {
